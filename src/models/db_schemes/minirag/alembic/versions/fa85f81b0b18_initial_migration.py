...
Revision ID: fa85f81b0b18
Revises: 
Create Date: 2026-03-01 23:17:10.391336
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunck_asset_id', 'chunks', ['chunk_asset_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_chunck_asset_id', table_name='chunks')
